...
func (mr *MockAggregateCursorMockRecorder) Decode(val any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAggregateCursorMockRecorder) Next(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAggregateCursorMockRecorder) TryNext(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Close indicates an expected call of Close.
func (mr *MockStreamCursorMockRecorder) Close(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Close", reflect.TypeOf((*MockStreamCursor)(nil).Close), ctx)
}

// Decode mocks base method.
func (m *MockStreamCursor) Decode(val any) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Decode", val)
	ret0, _ := ret[0].(error)
	return ret0
...
// Decode indicates an expected call of Decode.
func (mr *MockStreamCursorMockRecorder) Decode(val any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// Next indicates an expected call of Next.
func (mr *MockStreamCursorMockRecorder) Next(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// TryNext indicates an expected call of TryNext.
func (mr *MockStreamCursorMockRecorder) TryNext(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockCollectionAdapter) Aggregate(ctx context.Context, pipeline any, opts ...options.Lister[options.AggregateOptions]) (AggregateCursor, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCollectionAdapterMockRecorder) Aggregate(ctx, pipeline any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockCollectionAdapter) Watch(ctx context.Context, pipeline any, opts ...options.Lister[options.ChangeStreamOptions]) (StreamCursor, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, pipeline}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (mr *MockCollectionAdapterMockRecorder) Watch(ctx, pipeline any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, pipeline}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Watch", reflect.TypeOf((*MockCollectionAdapter)(nil).Watch), varargs...)
}

// MockcursorCloser is a mock of cursorCloser interface.
type MockcursorCloser struct {
	ctrl     *gomock.Controller
	recorder *MockcursorCloserMockRecorder
	isgomock struct{}
}

// MockcursorCloserMockRecorder is the mock recorder for MockcursorCloser.
type MockcursorCloserMockRecorder struct {
	mock *MockcursorCloser
}

// NewMockcursorCloser creates a new mock instance.
func NewMockcursorCloser(ctrl *gomock.Controller) *MockcursorCloser {
	mock := &MockcursorCloser{ctrl: ctrl}
	mock.recorder = &MockcursorCloserMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockcursorCloser) EXPECT() *MockcursorCloserMockRecorder {
	return m.recorder
}

// Close mocks base method.
func (m *MockcursorCloser) Close(arg0 context.Context) error {
	m.ctrl.T.Helper()
...
// Close indicates an expected call of Close.
func (mr *MockcursorCloserMockRecorder) Close(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Close", reflect.TypeOf((*MockcursorCloser)(nil).Close), arg0)
}
