...
func (mr *MockKafkaRecorderMockRecorder) IncKafkaClientProduceCounter(topic any) *gomock.Call {
...
func (mr *MockKafkaRecorderMockRecorder) IncKafkaProducerErrorCounter(topic any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKafkaRecorderMockRecorder) IncKafkaProducerSuccessCounter(topic any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKafkaRecorderMockRecorder) RegisterOn(registry any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockKafkaRecorderMockRecorder) Unregister(registry any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
